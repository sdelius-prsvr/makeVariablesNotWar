...
let myLastName = 'Delius'
let myBestFriend = 'Lauren'
let mySentence = '"My name is " + myFirstName + " " + myLastName + " and my wife, " + myBestFriend + " is my best friend."'
let myFavoriteNum = 3
let myMentalAge = 17
let myHeight = 71
let myFavoriteYear = 1996
